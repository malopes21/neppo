...
public class AuthenticationRuleCheckThrottling extends AbstractAuthenticationRule implements AuthenticationRuleValidator {

	
	public AuthenticationRuleCheckThrottling(AuthenticationRule rule) {
		this.setRule(rule);
	}
