...
public class SamlPrinter extends DefaultHandler {
	 ...
	 * content.
	 */
	public static String print(byte[] content) {
		try {
			SamlPrinter pretty = new SamlPrinter();
	 ...
	 * content.
	 */
	public static String print(InputStream content) {
		try {
			SamlPrinter pretty = new SamlPrinter();
			SAXParserFactory factory = SAXParserFactory.newInstance();
			factory.setFeature(
	...
	public static class StreamAdapter extends OutputStream {
		...
		public void flushPretty() throws IOException {
			...
			finalPrinter.println(SamlPrinter.print(out.toByteArray()));
			finalPrinter.close();
			out.close();
		}
	...
	public void startElement(String URI, String name, String qName,
		...
		for (int a = 0; a < length; ++a)
			...
			.append(attributes.getQName(a)).append("=\"")
