package com.neppo.authenticatorserver.dao.util;
...
public class HttpClientUtils {
	...
	public static HttpResponse sendPut(String url, List<NameValuePair> headers, String content ) throws ClientProtocolException, IOException {
